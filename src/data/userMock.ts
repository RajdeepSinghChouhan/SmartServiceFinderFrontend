export type BookingStatus = "PENDING" | "ACCEPTED" | "COMPLETED" | "CANCELLED" | "REJECTED";
...
export const mockBookings: Booking[] = [
  ...
  { id: 5002, userId: 1001, providerId: 4, serviceId: 105, serviceTitle: "Deep Home Cleaning (3 BHK)", providerName: "SparklePro Cleaning", bookingDate: "2026-07-05", bookingTime: "09:00", address: "123, MG Road, Bengaluru", notes: "Please bring eco-friendly products", status: "ACCEPTED", createdAt: "2026-06-22", price: 2499 },
...
export const mockNotifications: AppNotification[] = [
  { id: 7001, userId: 1001, email: "demo@ssf.app", title: "Booking Accepted", message: "Your booking for Deep Home Cleaning has been accepted.", type: "BOOKING_ACCEPTED", status: "SENT", isRead: false, createdAt: "2026-06-24", sentAt: "2026-06-24" },
